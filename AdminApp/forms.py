...
class LocationModelForm(forms.ModelForm):
    ...
    def clean_location(self):
        ...
        if LocationModel.objects.filter(location=location).exists():
            raise forms.ValidationError("This location already exists. Please choose a different one.")
        return location
...
class PlacesModelForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(PlacesModelForm, self).__init__(*args, **kwargs)
        self.fields['location'].queryset = LocationModel.objects.all()  # Set queryset for car dropdown
